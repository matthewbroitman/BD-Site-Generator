...
def generate_page(from_path,template_path,dest_path,basepath):
    ...
    template_string = template_string.replace('href="/','href="' + basepath)
    template_string = template_string.replace('src="/','src="' + basepath)
...
def generate_page_recursively(dir_path_content,template_path,dest_dir_path,basepath):
    ...
    for item in items:
        ...
        if os.path.isdir(item_path):
            generate_page_recursively(item_path,template_path,dest_item_path,basepath)
